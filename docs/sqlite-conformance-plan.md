...
2. External compiler testbed gate:
   ...
   object modes, TinyCC stripped compiler object emission, OCaml `ocamlyacc`
   clang differentials, and tree-sitter parser/query APIs in kimicc assembly
   and direct Mach-O object modes.
