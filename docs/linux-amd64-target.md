...
`inttypes.h`, `locale.h`, `math.h`, `netdb.h`, `netinet/in.h`, `pthread.h`,
`setjmp.h`, `wchar.h`, `sys/mman.h`, `sys/resource.h`, `sys/select.h`,
...
`inet_pton`, `inet_ntop`, `getaddrinfo`, `freeaddrinfo`, `fork`, `_exit`,
